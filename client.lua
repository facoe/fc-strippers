...
Citizen.CreateThread(function()
    ...
    Wait(10)
		...
		for _, item in pairs(Config.Locations18) do
			local npc = CreatePed(1, 0x52580019, item.x, item.y, item.z, item.heading, false, true)
			local npc2 = CreatePed(1, 0x52580019, item.x, item.y, item.z, item.heading, false, true)
...
Citizen.CreateThread(function()
	...
	for _, item in pairs(Config.Locations22) do
		...
		local netScene1 = CreateSynchronizedScene(item.x, item.y, item.z, vec3(0.0, 0.0, 0.0), 2)
		TaskSynchronizedScene(npc, netScene1, "mini@strip_club@pole_dance@pole_dance1", "pd_dance_01", 1.0, -4.0, 261, 0, 0)
		SetSynchronizedSceneLooped(netScene1, 1)
		SetModelAsNoLongerNeeded(model)
	end
end) 
...
Citizen.CreateThread(function()
    ...
    Wait(10)
		...
		for _, item in pairs(Config.Locations27) do
			local npc = CreatePed(1, 0x52580019, item.x, item.y, item.z, item.heading, false, true)
			local npc2 = CreatePed(1, 0x52580019, item.x, item.y, item.z, item.heading, false, true)
			local ad = "mini@strip_club@lap_dance_2g@ld_2g_p2"
...
Citizen.CreateThread(function()
	...
	for _, item in pairs(Config.Locations28) do
		local npc = CreatePed(1, 0x5C14EDFA, item.x, item.y, item.z, item.heading, false, true)
...
Citizen.CreateThread(function()
	...
	for _, item in pairs(Config.Locations29) do
		local npc = CreatePed(1, 0x52580019, item.x, item.y, item.z, item.heading, false, true)
...
Citizen.CreateThread(function()
	...
	for _, item in pairs(Config.Locations30) do
		local npc = CreatePed(1, 0x52580019, item.x, item.y, item.z, item.heading, false, true)
...
Citizen.CreateThread(function()
	...
	for _, item in pairs(Config.Locations31) do
		local npc = CreatePed(1, 0x5C14EDFA, item.x, item.y, item.z, item.heading, false, true)
...
Citizen.CreateThread(function()
	...
	for _, item in pairs(Config.Locations32) do
		local npc = CreatePed(1, 0x5C14EDFA, item.x, item.y, item.z, item.heading, false, true)
...
Citizen.CreateThread(function()
	...
	for _, item in pairs(Config.Locations33) do
		local npc = CreatePed(1, 0x52580019, item.x, item.y, item.z, item.heading, false, true)
...
Citizen.CreateThread(function()
	...
	for _, item in pairs(Config.Locations34) do
		local npc = CreatePed(1, 0x5C14EDFA, item.x, item.y, item.z, item.heading, false, true)
...
Citizen.CreateThread(function()
	...
	for _, item in pairs(Config.Locations35) do
		local npc = CreatePed(1, 0x52580019, item.x, item.y, item.z, item.heading, false, true)
